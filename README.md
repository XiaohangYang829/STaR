...
#### 1. Download the motion data from the **[Adobe Mixamo](https://www.mixamo.com)**. The JavaScript can be pasted and used in browsers like Chrome. Download one sample motion before running the script to fix the motion parameters (like wo_skin and FPS).
...
│       ├── inference
│           ├── inference_data.npy    # option 1, downloaded from Google Drive
│           ├── inference_q           # option 2, generated by the preprocess scripts
│           └── inference.json
│       ├── scale_info
│       ├── shape
│       ├── stats
│       ├── test
│           ├── test_data.npy         # option 1, downloaded from Google Drive
│           ├── test_q                # option 2, generated by the preprocess scripts
│           └── test.json
│       ├── test_shape
│       ├── texture_datapath
│       └── train
│           ├── train_data.npy        # option 1, downloaded from Google Drive (not uploaded yet)
│           ├── train_q               # option 2, generated by the preprocess scripts
│           └── train.json
│   ├── other_dataset/
│   ├── train_set.py
│   ├── test_set.py
...
<p align="center">
  <img src="assets/default.png" alt="Default View Direction" width="30%" style="margin-right: 24px;"/>
  <span style="display:inline-block; width:24px;"></span>
  <img src="assets/rotate.png" alt="Rotated View Direction" width="30%"/>
</p>
